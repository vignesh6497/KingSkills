<?php
	...
	$arrayNotify = array("service" =>null,"sellerEmail"=>$customer, "date"=>$date, "time" => $time, "status" => $status[1], "message" => "Your order request has been accepted by the service provider.","customerEmail" => null, "orderID" => null, "customRequest" => null);
